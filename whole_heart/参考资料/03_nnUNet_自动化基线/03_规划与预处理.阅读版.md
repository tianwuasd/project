...
the [preprocessed data format reference](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/reference/preprocessed-data-format.md) for details,
...
Continue to [Train models](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/how-to/train-models.md).
