...
- [Plan and preprocess](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/how-to/plan-and-preprocess.md)
- [Train models](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/how-to/train-models.md)
- [Find the best configuration](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/how-to/find-best-configuration.md)
...
The recommended nnU-Net presets have changed! See [here](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/resenc_presets.md) how to unlock them!
...
[this](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/dataset_format.md) for information on how to set up datasets to be compatible with nnU-Net.
...
[preprocessed data format reference](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/reference/preprocessed-data-format.md) for what those are and how to rebuild them
...
You can influence the splits nnU-Net uses for 5-fold cross-validation (see [here](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/manual_data_splits.md)). If you
...
that all network trainings take less than 2 days. Refer to our [benchmarks](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/benchmarking.md) to see if your system is
...
and must adhere to the nnU-Net naming scheme for image files (see [dataset format](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/dataset_format.md) and
[inference data format](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/dataset_format_inference.md)!)
...
See [here](https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/run_inference_with_pretrained_models.md)
